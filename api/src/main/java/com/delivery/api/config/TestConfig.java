...
public class TestConfig implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Product p6 = new Product(null, "Toalha de Mesa Retangular", "Toalha decorativa com estampas florais",
                                ...
                                69.00);
                Product p7 = new Product(null, "Extensor de Rede Universal",
                                "Extensor ajustável para qualquer tipo de rede",
                ...
                User u1 = new User(
                                null,
                                "Benedita Malu Clarice da Conceição",
                                "maria@gmail.com",
                                "(91) 99379-7980",
                                "186.425.996-50",
                                encoder.encode("Aa!!!111)"),
                                ADMIN);
                User u2 = new User(
                                null,
